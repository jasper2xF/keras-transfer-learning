...
class Preprocessor:
    def __init__(self, train_jpeg_dir, train_csv_file, test_jpeg_dir, test_additional_jpeg_dir,
                 img_resize=(32, 32), validation_split=0.2, resized_input=False, process_count=cpu_count()):
        """
        ...
        :param resized_input: boolean
            Flag set if input is already of correct image size
        ...
        self.resized_input = resized_input
    ...
    def store_resized_input_images(self):
        """
        Resize and store images from input folders.

        :return:
        """
        self.store_resized_images(self.test_additional_jpeg_dir, self.test_additional_jpeg_dir + "_" + str(self.img_resize[0]))
        self.store_resized_images(self.test_jpeg_dir, self.test_jpeg_dir + "_" + str(self.img_resize[0]))
        self.store_resized_images(self.train_jpeg_dir, self.train_jpeg_dir + "_" + str(self.img_resize[0]))

        return None

    def store_resized_images(self, input_dir, output_dir):
        """
